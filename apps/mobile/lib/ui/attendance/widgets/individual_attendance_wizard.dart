    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ActionChip(
              avatar: const Icon(Icons.done_all, size: 12),
            ...
            ActionChip(
              avatar: const Icon(Icons.clear_all, size: 12),
              label: const Text('Deselect All'),
              onPressed: () => setState(_selectedStudentIds.clear),
            ),
            ActionChip(
              avatar: const Icon(Icons.flip, size: 12),
          ...
          Expanded(
            child: Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.event_busy, size: 16, color: Colors.grey[300]),
          ...
          Expanded(
            child: Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.filter_alt_off, size: 16, color: Colors.grey[300]),
                  const SizedBox(height: 16),
                  Text(
