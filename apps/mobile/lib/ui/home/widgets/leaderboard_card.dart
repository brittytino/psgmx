    ...
    return PremiumCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.emoji_events_outlined, color: Colors.orange.shade700, size: 16),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      '${idx + 1}',
                      style: TextStyle(fontWeight: FontWeight.bold, color: badgeColor, fontSize: 9),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${user.weeklyScore} solved this week', style: const TextStyle(fontSize: 8, color: Colors.grey)),
                      ],
                    ),
                  ),
                  Container(
