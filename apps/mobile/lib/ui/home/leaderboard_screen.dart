            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: Column(
                  ...
                  children: [
                    Text("${user.easySolved}", style: const TextStyle(color: Colors.green, fontSize: 8)),
                    Text("${user.mediumSolved}", style: const TextStyle(color: Colors.orange, fontSize: 8)),
                    Text("${user.hardSolved}", style: const TextStyle(color: Colors.red, fontSize: 8)),
                  ],
                ),
              );
            },
