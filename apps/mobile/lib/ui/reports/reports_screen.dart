            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.table_chart, color: Colors.blue, size: 16),
                ),
                ...
                SegmentedButton<String>(
                  segments: const [
                    ButtonSegment(
                      value: 'csv',
                      label: Text('CSV'),
                      icon: Icon(Icons.table_chart, size: 12),
                    ),
                    ButtonSegment(
                      value: 'text',
                      label: Text('Text'),
                      icon: Icon(Icons.text_snippet, size: 12),
                    ),
                  ],
...
class _ActionListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(title, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 11)),
      subtitle: Text(subtitle, style: const TextStyle(fontSize: 9)),
      trailing: Icon(Icons.chevron_right, size: 16, color: Theme.of(context).colorScheme.outline),
      onTap: onTap,
    );
  }
}
