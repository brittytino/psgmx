...
class UserProvider with ChangeNotifier {
  ...
  Future<void> _checkSpecialStates() async {
    ...
    try {
      ...
      debugPrint('[UserProvider] Error checking special states: $e');
      _needsCalibration = false;
      _needsGraduationScreen = false;
    }
  }
  ...
  Future<void> completeCalibration(int startingScore) async {
    ...
    try {
      ...
      try {
        await Supabase.instance.client.from('daily_five_streaks').upsert({
        ...
        debugPrint('[UserProvider] Error initializing daily_five_streaks: $e');
      }
      ...
      // Call readiness compute RPC to populate actual scores
      try {
        await Supabase.instance.client.rpc('compute_readiness_score', params: {
