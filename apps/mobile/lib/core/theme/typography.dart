...
class AppTypography {
  static TextTheme getTextTheme(bool isDark) {
    ...
    final jakartaTextTheme =
        GoogleFonts.plusJakartaSansTextTheme(base.textTheme);

    return jakartaTextTheme.copyWith(
      displayLarge: jakartaTextTheme.displayLarge
          ?.copyWith(fontWeight: FontWeight.bold, fontSize: 32),
      displayMedium: jakartaTextTheme.displayMedium
          ?.copyWith(fontWeight: FontWeight.bold, fontSize: 28),
      displaySmall: jakartaTextTheme.displaySmall
          ?.copyWith(fontWeight: FontWeight.bold, fontSize: 24),
      headlineLarge: jakartaTextTheme.headlineLarge
          ?.copyWith(fontWeight: FontWeight.w600, fontSize: 22),
      headlineMedium: jakartaTextTheme.headlineMedium
          ?.copyWith(fontWeight: FontWeight.w600, fontSize: 20),
      headlineSmall: jakartaTextTheme.headlineSmall
          ?.copyWith(fontWeight: FontWeight.w600, fontSize: 18),
      titleLarge: jakartaTextTheme.titleLarge
          ?.copyWith(fontWeight: FontWeight.w600, fontSize: 18),
      ...
      labelSmall: jakartaTextTheme.labelSmall?.copyWith(
