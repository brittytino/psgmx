            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 24,
                  backgroundColor: theme.colorScheme.primaryContainer,
                  child: Text(widget.user.name[0].toUpperCase(), style: const TextStyle(fontSize: 20)),
                ),
              ...
              children: [
                ...
                ...UserPermission.values.map((perm) {
                  return CheckboxListTile(
                    ...
                    subtitle: Text('Flag: ${perm.dbKey}', style: TextStyle(fontSize: 10, color: theme.colorScheme.outline)),
